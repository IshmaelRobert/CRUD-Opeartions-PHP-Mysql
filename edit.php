...
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap.min.css">  
  ...
  <link rel="stylesheet" href="http://cdn.datatables.net/1.11.3/css/jquery.dataTables.min.css">
	...
	<style>
	fieldset{width:70%;background-color:orange;}label{margin:20px;}
	...
	<input type="time"name="time"placeholder="time"value="<?php echo $time;?>"><br /><br />
	<br /><br />
	<input  class="sub btn btn-primary"type="submit"name="update"value="UPDATE">
